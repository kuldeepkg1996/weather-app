...
function App() {
  ...
  const handleClick=()=>{
    axios.get(`http://api.weatherstack.com/current?access_key=f42bb49cd3d1938f114bda7d8ce37359&query=${city}`)
    .then((response)=>{
  ...
  return (
    ...
    <h1>Weeather App using React Js</h1>
    <input type="text" className=' my-5 search' value={city} onChange={(e)=>{
